    ...
    public Connection conectar(){
        try{
            ...
            throw new SQLException();
                ...
                fl.Escribir("ClassNotFoundException: "+e.getMessage());
            }catch (NullPointerException e){
                JOptionPane.showMessageDialog(null, "NullPointerException: "+e.getMessage());
                FileManager fl= new FileManager();
                fl.Escribir("NullPointerException: "+e.getMessage());
            }finally{
            return conn;
        }
    }
